...
public class ConexaoMySql {
    ...
    private final static String URL = "jdbc:mysql://127.0.0.1/biblioteca_eliomar"; //endereço da base de dados do seu projeto, deve ser a mesma configurada lá no SGBD
